...
function Mybookings({ id, title, imgUrl, price, time }) {
  ...
  return (
    ...
    >
      <img
        src={`https://boiling-dusk-80419.herokuapp.com${imgUrl}`}
        alt="barber"
      ...
      <div className="p-4">
        ...
        <p className="text-center">{time.toDate().toString().slice(4, 10)}</p>
        <p className="text-center">{time.toDate().toString().slice(16, 21)}</p>
