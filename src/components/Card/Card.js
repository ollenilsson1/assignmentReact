...
function Card({ productid, title, price, desc, img }) {
  ...
  function updateSubmitHandler(event) {
    ...
    axios
      .put(
        `https://boiling-dusk-80419.herokuapp.com/products/${productid}`,
        {
          title: EnteredTitle,
      ...
      .then((response) => {
        ...
        axios
          .post(
            "https://boiling-dusk-80419.herokuapp.com/products/upload",
            data,
            {
              headers: {
                Authorization: `Bearer ${token}`,
  ...
  async function deleteProduct(id) {
    const response = await axios.delete(
      `https://boiling-dusk-80419.herokuapp.com/products/${id}`,
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  return (
    ...
    >
      <img
        src={`https://boiling-dusk-80419.herokuapp.com${img.url}`}
        alt=""
