            ...
            <div className="grid place-items-center mx-2 my-20 sm:my-40">
                ...
                <div className="w-11/12 p-12 sm:w-8/12 md:w-6/12 lg:w-5/12 2xl:w-4/12 px-6 py-10 sm:px-10 sm:py-6 bg-white rounded-lg shadow-md lg:shadow-lg">
                    ...
                    <form className="mt-10">
                        ...
                        <input id="name" type="name" name="name" placeholder="För och efternamn.." autoComplete="name" className="block w-full py-3 px-1 mt-2 text-gray-800 appearance-none border-b-2 border-gray-100 focus:text-gray-500 focus:outline-none focus:border-gray-200" required />
